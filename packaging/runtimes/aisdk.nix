...
let
  ...
  package = pkgs.writeShellScriptBin "loom-aisdk-session" ''
    ...
    export PATH=${pkgs.lib.makeBinPath [ gitShim pkgs.bash pkgs.coreutils pkgs.findutils pkgs.gnugrep pkgs.gnused pkgs.curl pkgs.nix pkgs.git pkgs.gnutar pkgs.xz pkgs.deno ]}
